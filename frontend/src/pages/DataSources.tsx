...
const dataSourceRegistry = [
  {
    ...
    source: 'OpenRailwayMap Live Infrastructure & GIS Spatial Portal',
    is_simulated: false,
    publicUrl: 'https://www.openrailwaymap.org/',
  ...
  },
  {
    ...
    is_simulated: false,
    publicUrl: 'https://www.fois.indianrail.gov.in/FOISWebPortal/index.jsp#',
    recordsCount: '10 Express & Freight Schedules Loaded',
    description: 'Official Freight Operations Information System (FOIS) timetable data for freight and passenger train schedules.',
  },
  {
    table: 'ir_yearbook_stats',
    name: 'Indian Railways Year Book 2024-25 (Statistical Standards)',
    source: 'Ministry of Railways, Railway Board Statistical Directorate',
    is_simulated: false,
