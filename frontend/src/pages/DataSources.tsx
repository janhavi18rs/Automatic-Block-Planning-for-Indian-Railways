...
const dataSourceRegistry = [
  {
    ...
    source: 'OpenRailwayMap & HDX GIS Spatial Extract',
    is_simulated: false,
    publicUrl: 'https://data.humdata.org/dataset/openrailwaymap-railways',
  ...
  },
  {
    ...
    source: 'Kaggle & Open Railways Timetable Dataset',
    is_simulated: false,
    publicUrl: 'https://www.kaggle.com/datasets/irctc/indian-railways-dataset',
