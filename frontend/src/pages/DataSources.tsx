...
const dataSourceRegistry = [
  {
    ...
    is_simulated: false,
    publicUrl: 'https://github.com/datameet/railways',
  ...
  },
  {
    ...
    source: 'DataMeet & Published Open Railways Timetable Dataset',
    is_simulated: false,
    publicUrl: 'https://github.com/datameet/railways/tree/master/data',
